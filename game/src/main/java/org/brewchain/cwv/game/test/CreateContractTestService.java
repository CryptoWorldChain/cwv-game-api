...
import org.brewchain.test.service.Test.ReqCreateContract;
...
@Slf4j
@Data
public class CreateContractTestService extends SessionModules<ReqCreateContract> {
	...
	public String[] getCmds() {
		return new String[] { PWLTTestCommand.NCR.name() };
	}
	...
	public void onPBPacket(final FramePacket pack, final ReqCreateContract pb, final CompleteHandler handler) {
		RespCreateContractTransaction.Builder ret = wltHelper.createContract(pb.getAddress(), new BigDecimal(pb.getAmount()), pb.getType());
