...
@Slf4j
@Data
public class MapPropertyDetailService extends SessionModules<PSMapPropertyDetail> {
...
//	
	...
	public String[] getCmds() {
		return new String[] { PTPSCommand.MPD.name() };
	}
	...
	@Override
	public void onPBPacket(final FramePacket pack, final PSMapPropertyDetail pb, final CompleteHandler handler) {
		...
		try{
			propertyHelper.getMapPropertyDetail(pb, ret, builder);
